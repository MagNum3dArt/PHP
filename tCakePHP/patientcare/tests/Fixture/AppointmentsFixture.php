...
class AppointmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'appointment_day' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'patient_id' => 1,
            'doctor_id' => 1,
            'appointment_day' => '2016-10-29 08:31:33',
            'created' => '2016-10-29 08:31:33',
            'modified' => '2016-10-29 08:31:33'
        ],
    ];
}
